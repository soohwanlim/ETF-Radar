...
const FAQS = [
  {
    ...
    answer: '국내 주식형 현물 ETF의 종가 수익률, TOP 10 구성종목 변화, 신규 상장 ETF, 액티브 ETF 공통 구성수량 증가 종목을 매일 정리해 보여주는 데이터 서비스입니다. 특정 ETF를 추천하기보다 사용자가 여러 ETF를 같은 기준으로 비교하도록 돕는 것이 목적입니다.',
  },
  {
  ...
  {
    question: '액티브 ETF 공통 증가 종목은 매수 추천인가요?',
    answer: '아닙니다. 액티브 ETF 공통 증가 종목은 여러 액티브 ETF에서 같은 종목의 1CU당 구성수량이 함께 증가한 경우를 모아 보여주는 관찰 지표입니다. 운용사들의 공통 관심을 살피는 데 도움을 줄 수 있지만, 특정 종목이나 ETF의 매수를 권유하는 의미는 아닙니다.',
  },
  {
