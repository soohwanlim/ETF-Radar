...
export default function Guide() {
  return (
    <div className="mx-auto max-w-4xl space-y-6 fade-in">
      ...
      <GuideSection title="액티브 ETF 공통 증가 종목" icon={TrendingUp}>
        <p>
          액티브 ETF 공통 증가 종목은 최근 7일 동안 여러 액티브 ETF에서 같은 종목의 1CU당 구성수량이 증가한 경우를 모아 보여줍니다.
          액티브 ETF는 운용사의 판단이 더 많이 반영될 수 있으므로, 여러 액티브 ETF에서 동시에 늘어난 종목은 관찰 가치가 있습니다.
        </p>
        <p>
          다만 이 지표는 투자 추천이 아니라 운용 변화 관찰용 참고 지표입니다. 운용사별 전략, ETF의 테마, 종목 가격 변화, 리밸런싱 시점이 모두 다르기 때문에
