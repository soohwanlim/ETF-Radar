...
const articles = [
  ...
  },
  {
    ...
    paragraphs: [
      '액티브 ETF 페이지의 공통 증가 종목은 최근 7일 동안 여러 액티브 ETF에서 1CU당 구성수량이 증가한 종목을 우선 보여줍니다. 짧은 기간을 쓰는 이유는 액티브 ETF의 장점이 빠른 대응에 있기 때문입니다.',
      '이 지표는 매수 추천이 아니라 “여러 운용 전략에서 동시에 관찰된 변화”입니다. 같은 삼성전자를 늘렸더라도 AI 인프라 ETF, 밸류업 ETF, 코스피 액티브 ETF에서 늘린 이유는 서로 다를 수 있습니다. 따라서 어떤 ETF들이 늘렸는지 펼쳐서 확인하는 과정이 중요합니다.',
