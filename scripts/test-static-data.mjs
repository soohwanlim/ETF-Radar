...
import { canonicalPath, canonicalUrl } from '../src/data/siteUrls.js';

assert.equal(canonicalPath('/etf/069500'), '/etf/069500/');
assert.equal(canonicalPath('/insights/?ref=test'), '/insights/');
assert.equal(canonicalPath('/'), '/');
assert.equal(canonicalUrl('/about'), 'https://etf-radar.net/about/');
